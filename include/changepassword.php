  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         ...
         <li><a href="changepassword.php">
             <?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['st']);unset($_SESSION['ut']);unset($_SESSION['sp']);}else{$_SESSION['lc']=0;}?><i class="glyphicon glyphicon-cog"></i>&nbsp;<span>Change Password</span></a></li>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="btn btn-default" id="click" name="submitButton">
          <?php 
          if(isset($_SESSION['st']) || isset($_SESSION['sp']) || isset($_SESSION['ut']))
          {
            unset($_SESSION['st']); unset($_SESSION['sp']); unset($_SESSION['ut']);
          }
          ?>
