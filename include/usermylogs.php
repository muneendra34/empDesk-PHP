  ...
  <header class="main-header">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li><a href="../index.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==1) {unset($_SESSION['ress']);}else{$_SESSION['lc']=1;}?><i class="glyphicon glyphicon-home"></i><span>&nbsp;Home</span></a></li>
          <li><a href="usermylogs.php"><i class="glyphicon glyphicon-user"></i>&nbsp;
                    <span>My Log Details</span></a></li>
         <li><a href="changepassword.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['st']);unset($_SESSION['ut']);}else{$_SESSION['lc']=0;}?><i class="glyphicon glyphicon-cog"></i>&nbsp;<span>Change Password</span></a></li>
          <li><a href="logout.php"><i class="glyphicon glyphicon-log-out"></i>&nbsp;<span>Logout</span></a></li> </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
