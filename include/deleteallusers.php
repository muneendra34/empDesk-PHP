  ...
  <header class="main-header">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li><a href="../admin.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['st']);unset($_SESSION['ut']);}else{$_SESSION['lc']=0;}?><i class="glyphicon glyphicon-home"></i>
            <span>&nbsp;Home</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i></span></a></li>
           <li><a href="deleteallusers.php"><i class="glyphicon glyphicon-user"></i>&nbsp;
           ...
           <li><a href="dlogs.php"><i class="glyphicon glyphicon-align-justify"></i>&nbsp;
            <span>Delete All Logs</span>
          
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i></span></a></li>
          <li><a href="logout.php"><i class="glyphicon glyphicon-log-out"></i>&nbsp;
            <span>Logout</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i></span></a></li> </ul>             
        </section>
        <!-- /.sidebar -->
      </aside>
